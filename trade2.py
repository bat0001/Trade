...
class Bot:
    ...
    def make_decision(self):
        ...
        if dollars < 100:
            ...
            # Evaluate Bollinger Bands for decision making
    ...
    def sell_order(self, pair: str, amount: float):
        if pair in self.botState.stacks and self.botState.stacks[pair] >= amount:
...
class BotState:
    def __init__(self):
        ...
        self.stacks = dict()
        self.charts = dict()
        self.bollingerWindow = 20  # Fenêtre des bandes de Bollinger
        self.bollingerFactor = 2  # Facteur des bandes de Bollinger
